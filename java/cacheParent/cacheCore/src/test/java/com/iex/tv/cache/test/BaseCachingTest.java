...
import com.iex.tv.cache.test.data.CacheData;
import com.iex.tv.cache.test.data.CacheTestData;
...
public abstract class BaseCachingTest {
	...
	protected Set<String> initCache(Cache<?> cache) {
		//cache.clear();
		CacheData cacheData = cacheTestData.getCacheData(cache.getCacheName());
		if(cacheData == null) {
